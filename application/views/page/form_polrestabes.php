...
<head>
  <title>Form Impor Data Personel Polrestabes</title>
...
<body>
  <h3>Form Impor Data Personel Polrestabes</h3>
  <hr>
  ...
  <form method="post" action="<?php echo base_url("urmin/form_polrestabes"); ?>" enctype="multipart/form-data">
    <!-- 
  ...
  if (isset($_POST['preview'])) { // Jika user menekan tombol Preview pada form 
    ...
    echo "<form method='post' action='" . base_url("urmin/import") . "'>";
    ...
    <tr>
      <th colspan='10'>Tampilan Data</th>
    </tr>
    <tr>
        <th>Nama</th>
        <th>NRP</th>
    ...
    foreach ($sheet as $row) {
      ...
      $id_bagian = $row['J']; // Ambil data id bagian
      ...
      if ($numrow > 1) {
        ...
        if ($nama == "" or $nrp == "" or $pkt == "" or $jabatan == "" or $tempat == "" or $tgl_lahir == "" or $agama == "" or $suku == "" or $tmt_jab == "") {
  ...
  <?php
      ...
      echo "<a href='" . base_url("urmin/personel_polrestabes") . "'> Batalkan</a>";
    }
